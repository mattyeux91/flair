...
Pipeline déclaré (`bin/demo.php`, `harness/Sampler`) : `TrainingSystem`, `RetirementSystem`, `PlayerDevelopmentSystem` — les facteurs avant les effets, `TrainingSystem` doit écrire `TrainingEffect` avant que `PlayerDevelopmentSystem` le lise.
