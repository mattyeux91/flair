 ...
 * (pace vs stamina, etc.) parce qu'AgingSystem fait aujourd'hui vieillir tous
 * les attributs d'une meme categorie de facon identique (meme ageFactor, meme
 * declineMultiplier) - ce sont statistiquement la meme distribution.
 */
