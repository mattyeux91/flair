...
**Stade actuel : documentation figée (`docs/10-16`), aucun code, aucun `packages/`.** Prochaine étape : Phase 0 du `15-roadmap.md` (noyau nu, 1 pays/1 division/18 clubs, moteur L0 uniquement, sortie = rapport de saison en texte).
