...
1. **Les onze meilleurs dans `MatchSystem`.** Requalifié : ce n'était pas une limite assumée mais une **incitation économique inversée** (sous la moyenne, la valeur marginale d'un joueur de rotation est négative — acheter fait baisser la note du club), et elle ne demande **pas** `PositionAffinity` : trier par l'agrégat déjà calculé par joueur suffit. À corriger avant qu'un marché ne calibre ses prix contre ce signal. Effet secondaire accepté : la profondeur d'effectif devient neutre plutôt que valorisée, tant que blessures/rotation n'existent pas.
